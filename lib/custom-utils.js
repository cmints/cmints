 ...
 * @param {Strinf} filePath Full path to the page
 */
const pathnameFromfilePath = (filePath) =>
{
 ...
 */
const getPath = (pagePath, attributes) =>
{
  if (attributes.permalink)
    return attributes.permalink;
  else
    return pathnameFromfilePath(pagePath);
};

module.exports = {parseAttributes, getDeepValue, removeIndex, pathnameFromfilePath, getPath};
