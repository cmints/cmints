 ...
 * @param {String} pageDir pages directory path
 */
const pathnameFromfilePath = (filePath, pageDir) =>
{
  return removeIndex(path.relative(pageDir, filePath));
};

module.exports = {parseAttributes, getDeepValue, removeIndex, pathnameFromfilePath};
