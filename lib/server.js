...
const {ensureDirSync, copySync, removeSync} = require("fs-extra");
...
{
  const defaultLocaleContent = path.join(contentDir, defaultLocale);
  switch (generationType)
  {
    case "Index":
      copySync(defaultLocaleContent, contentDir);
      removeSync(defaultLocaleContent);
      break;
    case "Double":
      copySync(defaultLocaleContent, contentDir);
      break;
